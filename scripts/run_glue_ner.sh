...
train_datasets="mnli,rte,qqp,qnli,mrpc,sst,cola,stsb,ner"
test_datasets="ner"
...
lr="5e-5"
task_def="../experiments/conll/conll_task_def.yml,../experiments/glue/glue_task_def.yml"
